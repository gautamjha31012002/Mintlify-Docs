...
Here is the map of the territory. AI is a broad field; the part this docs uses lives several layers down inside it. Keep this picture in your head — we will refer back to it for the next eight chapters.
