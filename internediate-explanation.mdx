...
1. **An LLM is (almost) a pure function over text.** Stripe away the product wrapping and a language model is a function with a shape like this: 
   <Frame>
